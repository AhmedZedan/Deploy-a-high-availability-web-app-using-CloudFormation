...
![website running on servers](https://github.com/AhmedZedan/Deploy-a-high-availability-web-app-using-CloudFormation/master/workflow-screenshots/website id running on servers.png)
